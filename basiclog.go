...
func (b *basicLog) StdoutChan() chan data {
	return b.stdoutChan
}

func (b *basicLog) FileChan() chan data {
	return b.fileChan
}

func (b *basicLog) MultiChan() chan data {
	return b.multiChan
}

func (b *basicLog) ServiceStop() chan trigger {
	return b.serviceStop
}

func (b *basicLog) ServiceStarted() chan trigger {
	return b.serviceStarted
}

func (b *basicLog) FileHandle() *os.File {
	return b.fileHandle
}

func (b *basicLog) StdoutLogger() *log.Logger {
	return b.stdoutLogger
}

func (b *basicLog) FileLogger() *log.Logger {
	return b.fileLogger
}

func (b *basicLog) initialize(logName string) {
	// setup log file
	var err error
